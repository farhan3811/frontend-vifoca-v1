...
<table style="width: 100%;border: 1px solid black;">
  <tbody>
    <tr>
      <td style="width: 20%;border: 1px solid black;">CPMK</td>
      <td style="width: 80%;border: 1px solid black;"></td>
    </tr>
    <tr>
      <td style="width: 20%;border: 1px solid black;">Indikator</td>
      <td style="width: 80%;border: 1px solid black;"></td>
    </tr>
    <tr>
      <td style="width: 20%;border: 1px solid black;">Uraian Materi</td>
      <td style="width: 80%;border: 1px solid black;"></td>
    </tr>
    <tr>
      ...
      <td style="width: 80%;border: 1px solid black;"></td>
        ...
        init={{
          ...
          menubar: true,
          plugins:
            "eqneditor visualchars image table media wordcount link autoresize code pagebreak lists",
          toolbar:
            "undo redo customImageGallery drawioButton table | eqneditor image media numlist bullist | formatselect bold italic backcolor removeformat pagebreak | alignleft aligncenter alignright alignjustify | link outdent indent downloadImage",
          image_title: true,
          table_toolbar:
          ...
          setup: (editor) => {
            ...
            editor.on("click", (event) => {
              ...
              if (
                target.nodeName === "IMG" &&
                target.getAttribute("data-edit-url")
              ) {
