      ...
      axios
        ...
        .then((response) => {
          if (response.data) {
            ...
            setFileName(
              response.data.foto_tugas ? response.data.foto_tugas.split("/").pop() : ""
            );
          }
        })
        .catch((error) => {
          console.error("Error fetching latihan data:", error);
          setErrorMessage("Gagal mengambil data tugas.");
        });
    }
  }, [id]);
    ...
    <div className="p-8">
      ...
      <Card color="bg-white" shadow={true}>
        <Typography
          variant="h4"
          color="blue-gray"
          className="flex font-title mt-4 font-medium justify-center items-center"
        >
          Latihan
        </Typography>
        {successMessage && (
        ...
        <form className="mt-8 mb-2 w-full px-8" onSubmit={handleSubmit}>
          <div className="mb-1 gap-4">
            ...
            <div className="grid grid-cols-5">
              ...
              <div className="col-span-4 relative mb-4">
                <input
                  type="file"
                  id="file-input"
                  accept="image/*"
            ...
            <div className="grid grid-cols-5 mb-4">
              ...
              <div className="col-span-4">
                ...
                <DatePicker
                  ...
                  type="text"
                  dateFormat="Pp"
                  className="border rounded border-gray-300 p-2 w-full bg-white"
                />
              </div>
            </div>
            <div className="grid grid-cols-5 mb-4">
