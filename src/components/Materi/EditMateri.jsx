...
export function EditHalaman() {
  ...
  useEffect(() => {
    const getMateri = async () => {
      try {
        ...
        setFileName(
          materi.img_materi ? materi.img_materi.split("/").pop() : ""
        );
      } catch (error) {
        setErrorMessage("Gagal memuat data materi.");
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`${API_URL}/materi/${id}`, data, {
        headers: {
